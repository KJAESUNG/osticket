...
# Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','user02osticketsrv01.mysql.database.azure.com');
define('DBNAME','osticket');
define('DBUSER','user02osticketsrv01.mysql.database.azure.com');
define('DBPASS','demouser@user02osticketsrv01');
